          ...
          <form>
            ...
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-md font-semibold leading-none text-white focus:outline-none bg-indigo-950 border rounded hover:bg-indigo-900 py-4 w-full"
              >
                Forgot Password?
              </button>
            </div>
